...
const FlatListItem = ({fetch,requester_item,status,setStatus,user,navigation, item, onPress, onMessagePress, backgroundColor, textColor }) => (
        ...
        <TouchableOpacity style={[styles.item, backgroundColor]} >
            <View>           
                 <UserAvatar src={item.requester_item.picture} style={styles.imageBox}/>
                 <Text style={[styles.status]}>{item.status}</Text>
            </View>
            <View>
                {console.log("Requester",requester_item)}
                <Text style={[styles.title, styles.text]}>{item.requester_item.name}</Text>
